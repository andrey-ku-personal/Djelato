...
namespace Djelato.Web.ViewModel.FluentApi
{
    public class UserValidator : AbstractValidator<UserDTO>
    {
        public UserValidator()
        {
            ...
            RuleFor(u => u.ConfirmPassword).NotEmpty().WithMessage("Confirm field cant be empty");
            RuleFor(u => u.ConfirmPassword).NotNull().WithMessage("Confirm field should be fill in");
